...
public class character : MonoBehaviour {
    ...
    void Update() {
        for(int i = 0; i < transform.childCount; i++) transform.GetChild(i).GetComponent<corgi_move>().isEnabled = false;
        transform.GetChild(index).GetComponent<corgi_move>().isEnabled = true;
